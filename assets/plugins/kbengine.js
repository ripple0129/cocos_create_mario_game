...
KBEngine.create2 = KBEngine.Class.extend
{
        cc.log("createKBE")
        var kbeargs = new KBEngine.KBEngineArgs();
        KBEngine.create(kbeargs)
        cc.log("ip:"+kbeargs.ip)
}
...
KBEngine.Account = KBEngine.Entity.extend(
{
  ...
  depositOne : function(){
    this.baseCall('depositOne')
  },

  depositTwo : function(){
    this.baseCall('depositTwo')
  },

  addMoney : function(money)
	{
		this.baseCall("addMoney", money);
	},

  lessMoney : function(money)
	{
		this.baseCall("lessMoney", money);
	},

  pressBarButton : function()
	{
	    this.baseCall("pressBarButton")
	},
  ...
  pressSevenButton : function()
	{
	    this.baseCall("pressSevenButton")
	},

  pressStarButton : function()
	{
	    this.baseCall("pressStarButton")
	},

  pressWatermelonButton : function()
	{
	    this.baseCall("pressWatermelonButton")
	},

  pressBellButton : function()
	{
	    this.baseCall("pressBellButton")
	},

  pressSnakemelonButton : function()
	{
	    this.baseCall("pressSnakemelonButton")
	},

  pressOrangeButton : function()
	{
	    this.baseCall("pressOrangeButton")
	},

  pressAppleButton : function()
	{
	    this.baseCall("pressAppleButton")
	},

  pressStartButton : function()
	{
	    this.baseCall("pressStartButton")
	},

  pressWinScoreToMoneyButton : function()
	{
	    this.baseCall("pressWinScoreToMoneyButton")
	},

  pressClearButton : function()
	{
	    this.baseCall("pressClearButton")
	},

  pressBigButton : function()
	{
	    this.baseCall("pressBigButton")
	},

  pressSmallButton : function()
	{
	    this.baseCall("pressSmallButton")
	},

  getAccountInfo : function()
  {
     this.baseCall("getAccountInfo")
  },

  onGetAccountInfo : function(info)
  {
    KBEngine.Event.fire("onGetAccountInfo",info)
  }
